...
public class BcoinsFragment extends SherlockFragment {
		...
		case R.id.refresh:		
			...
			if(webView !=null){
				if(done==true){							
					...
					if(lang.equals("vi"))	 
						webView.loadUrl("http://m.biitbook.com/account/" + userid);
					else
						webView.loadUrl("touch.biitbook.me/account/" + userid);
					done = false;
				}
				 try {
				       timer = new Timer();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){		
		...
		lang = golbal.loadSavedPreferences("KEY_LANG");
		View v;
		super.onCreate(savedInstanceState);
		if(userid.equals("")){
	        ...
	        webView.setWebChromeClient(new WebChromeClient(){
                   ...
                   public void onProgressChanged(WebView view, int newProgress) {
              		 	BcoinsFragment.this.setValue(newProgress);
