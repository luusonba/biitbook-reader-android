...
public class Utils {
	...
	public static File createCacheDir(Context context)  {
		...
		if (android.os.Environment.MEDIA_MOUNTED.equals(android.os.Environment.getExternalStorageState())) {
			...
			preparedDir = new File(Environment.getExternalStorageDirectory() + "/Android/data/com.biitbook.android/images/");			
            Log.i(TAG, "Cache dir initialized at SD card " + preparedDir.getAbsolutePath());
        } else {
			//preparedDir = context.getCacheDir();
			preparedDir = new File(Environment.getDataDirectory() + "/data/com.biitbook.android/images/");
