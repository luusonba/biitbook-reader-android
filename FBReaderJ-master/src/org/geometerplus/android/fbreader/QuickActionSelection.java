...
public class QuickActionSelection extends PopupWindows implements OnDismissListener {
	 ...
	 */
	public QuickActionSelection(Context context) {
		super(context);
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickActionSelection.this, pos, actionId);
                }
	 ...
	 */
	public void setOnDismissListener(QuickActionSelection.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionSelection source, int pos, int actionId);
	}
