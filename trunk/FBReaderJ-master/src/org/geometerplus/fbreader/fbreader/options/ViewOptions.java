...
public class ViewOptions {
	...
	public ViewOptions() {
		...
		LeftMargin =
			new ZLIntegerRangeOption("Options", "LeftMargin", 0, 100, 10);
		RightMargin =
			new ZLIntegerRangeOption("Options", "RightMargin", 0, 100, 10);
		TopMargin =
			new ZLIntegerRangeOption("Options", "TopMargin", 0, 100, 10);
		BottomMargin =
			new ZLIntegerRangeOption("Options", "BottomMargin", 0, 100, 10);
		SpaceBetweenColumns =
