...
public class MuPDFActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (core == null) {			
	   		if(golbal.loadSavedPreferences("KEY_ONOFF").equals("1")){
				try {
					String idbook = golbal.loadSavedPreferences("KEY_IDBOOK");
					path = golbal.loadSavedPreferences("KEY_PATHTMP")+idbook+golbal.loadSavedPreferences("KEY_EXTBOOK");
					File from = new File(golbal.loadSavedPreferences("KEY_PATHBOOK"),idbook);
								...
								alert.setButton(AlertDialog.BUTTON_POSITIVE, getString(R.string.dismiss),
										new DialogInterface.OnClickListener() {
											public void onClick(DialogInterface dialog, int which) {
												...
												finish();
												MuPDFActivity.this.startActivity(new Intent(MuPDFActivity.this, LibsActivity.class));
											}
										});
								alert.show();
								return;
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mDocView = new MuPDFReaderView(this) {
			...
			protected void onMoveToChild(int i) {
				...
				golbal.savePreferences("KEY_NUMBERPAGE", core.countPages()+"");
		...
		mFilenameView.setText(golbal.loadSavedPreferences("KEY_TITLE"));
